...
if (!text) throw `╰⊱❗️⊱ 𝘼𝘾𝘾𝙄𝙊𝙉 𝙈𝘼𝙇 𝙐𝙎𝘼𝘿𝘼 ⊱❗️⊱╮\n\n𝙀𝙎𝘾𝙍𝙄𝘽𝘼 𝙀𝙇 𝙉𝙊𝙈𝘽𝙍𝙀 𝙊 𝙏𝙄𝙏𝙐𝙇𝙊\n❏ 𝙀𝙅𝙀𝙈𝙋𝙇𝙊:\n❏ ${usedPrefix + command}`
try {
...
await await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `𝙎𝙝𝙖𝙙𝙤𝙬 𝘽𝙤𝙩-𝙎𝙓\n${ttl}`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch {   
try {  
...
await conn.sendMessage(m.chat, { video: { url: n2 }, fileName: `${n}.mp4`, mimetype: 'video/mp4', caption: `𝙎𝙝𝙖𝙙𝙤𝙬 𝘽𝙤𝙩-𝙎𝙓\n${n}`, thumbnail: await fetch(n4) }, { quoted: m })
} catch {
}}}}} catch {
}}
